...
class ElasticQuantBinarizerSigned(torch.autograd.Function):
    ...
    """
    @staticmethod
    def forward(ctx, input, alpha, num_bits=1, layerwise=True):
        """
...
class BinaryLinear(nn.Linear):
    def __init__(self, *kargs, clip_val=2.5, weight_bits=1, input_bits=1, learnable=True, symmetric=True,
                 weight_layerwise=True, input_layerwise=True, weight_quant_method="bwn", input_quant_method="elastic",
                 **kwargs):
