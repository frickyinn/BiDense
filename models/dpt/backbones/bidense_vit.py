...
class Block(nn.Module):
    def __init__(self, dim, num_heads, mlp_ratio=4.0, qkv_bias=False, proj_bias=True, ffn_bias=True, drop=0.0, attn_drop=0.0, init_values=None):
        super().__init__()
...
class VisionTransformer(nn.Module):
    def __init__(
        ...
        qkv_bias=True, ffn_bias=True, proj_bias=True, init_values=None, interpolate_antialias=False, interpolate_offset=0.1,
    ):  
        super().__init__()
        ...
        self.blocks = nn.ModuleList([
            Block(dim=embed_dim, num_heads=num_heads, mlp_ratio=mlp_ratio, qkv_bias=qkv_bias, proj_bias=proj_bias, ffn_bias=ffn_bias, init_values=init_values)
