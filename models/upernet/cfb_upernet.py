...
from binary.cfb import CFBConv2d, LearnableBias
from .backbones.cfb_convnext import get_convnext
...
class CFBUperNetDepthModel(UperNet):
...
class CFBUperNetSegmentationModel(UperNet):
